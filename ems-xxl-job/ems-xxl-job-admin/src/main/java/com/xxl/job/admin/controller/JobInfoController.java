...
public class JobInfoController {
  ...
  @RequestMapping("/loadByHandler")
  @ResponseBody
  public ReturnT<XxlJobInfo> loadByHandler(int groupId, String executorHandler,String executorParam) {
    XxlJobInfo jobInfo = null;
    try {
      jobInfo = xxlJobService.loadByHandler(groupId, executorHandler,executorParam);
