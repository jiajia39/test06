...
public class JobGroupController {
  ...
  @ResponseBody
  public ReturnT<XxlJobGroup> findByAppName(String appName) {
    List<XxlJobGroup> jobGroupList = xxlJobGroupDao.findByAppName(appName);
    XxlJobGroup jobGroup = null;
    if (jobGroupList != null && !jobGroupList.isEmpty()) {
      jobGroup = jobGroupList.get(0);
    }
