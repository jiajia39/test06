...
@Getter
@Setter
public class ExceptionProcessUpdateRequest implements Serializable {
    ...
    @ApiModelProperty(value = "提报附加字段id列表")
    ...
    @ApiModelProperty(value = "响应附加字段id列表")
    ...
    @ApiModelProperty(value = "验收附加字段id列表")
    ...
    public ExceptionProcessUpdateRequest init() {
