...
@Getter
@Setter
public class FormFieldCreateRequest implements Serializable {
    ...
    @EnumValidator(enumClazz = FormFieldSubTypeEnum.class, message = "字段子类型 input:0:普通文本 1:文本区域 select:0:单选 1:多选")
