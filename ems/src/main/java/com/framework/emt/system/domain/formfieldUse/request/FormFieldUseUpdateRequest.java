 ...
 */
@ApiModel(value = "异常单字段使用表更新参数")
@Data
public class FormFieldUseUpdateRequest implements Serializable {
     ...
     */
    @ApiModelProperty(value = "0:异常提报 1:异常响应 2:异常处理 3:异常挂起 4:异常协同 5:异常验收")
