...
@Getter
@Setter
public class TaskExportQueryRequest implements Serializable {
    ...
    @Size(max = 10000, message = "异常任务id数目最大{max}条")
    @UniqueElementsValidator(message = "异常任务id不能重复")
    @ApiModelProperty(value = "异常任务id列表")
